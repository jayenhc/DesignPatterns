...
public class ComputerAbstractFactoryTest {
    ...
    public void getComputer() throws Exception {
        Computer pc = ComputerFactory.getComputer(new PCFactory(PC_RAM, PC_HDD, PC_CPU));
        Computer server = ComputerFactory.getComputer(new ServerFactory(SERVER_RAM, SERVER_HDD, SERVER_CPU));
